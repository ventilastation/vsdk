...
class TutorialVs2(vs2.Scene):
    ...
    def build(self):
        ...
        self.entries = [
            {"name": "BICHOS", "sprite": self.world.sprite("galaga.png", x=-8, y=16, frame=6), "xq": -32, "yq": 64},
            {"name": "SIGN", "sprite": self.hud.sprite("gameover.png", x=224, y=16), "xq": 896, "yq": 64},
            {"name": "PLANET", "sprite": self.fullscreen.sprite("bembi.png", x=0, y=255), "xq": 0, "yq": 1020},
            {"name": "VOOM", "sprite": self.fullscreen.sprite("doom.png", x=0, y=255), "xq": 0, "yq": 1020},
        ]
        self.current = 0
        self.flip_state = 0
        self.x_direction = 0
