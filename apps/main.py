...
def main():
    ...
    director.register_strip(30, imagenes.chanime01_flat_png)
    director.register_strip(31, imagenes.chanime02_flat_png)
    director.register_strip(32, imagenes.chanime03_flat_png)
    director.register_strip(33, imagenes.chanime04_flat_png)
    director.register_strip(34, imagenes.chanime05_flat_png)
    director.register_strip(35, imagenes.chanime06_flat_png)
    director.register_strip(36, imagenes.chanime07_flat_png)
    director.register_strip(37, imagenes.salto01_flat_png)
    director.register_strip(38, imagenes.salto02_flat_png)
    director.register_strip(39, imagenes.salto03_flat_png)
