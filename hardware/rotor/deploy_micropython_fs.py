...
def main():
    ...
    parser.add_argument(
        ...
        default=0x5F0000,
        help="Flash offset of the VFS partition (default: 0x5F0000, matches partitions-voom.csv)",
    )
    parser.add_argument(
        "--partition-size",
        type=lambda x: int(x, 0),
        default=0xA10000,
        help="VFS partition size in bytes (default: 0xA10000, matches partitions-voom.csv)",
    )
    parser.add_argument(
        "--idf-path",
        type=pathlib.Path,
