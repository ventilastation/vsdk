...
class Tablero:
    ...
    def rotate(self):
        ...
        if not self.collision(self.current.col, self.current.row, new_rotation):
            ...
            director.sound_play("vsjam-may25.vortris/bajar1")
            return True
        else:
            return False
    ...
    def drop(self):
        if not self.move(0, 1):
            self.freeze()
            director.sound_play("vsjam-may25.vortris/encastre")
        else:
            director.sound_play("vsjam-may25.vortris/bajar1")
...
class Vortris(Scene):
    stripes_rom = "vsjam-may25.vortris"
    ...
    def step(self):
        ...
        if director.was_pressed(director.JOY_LEFT):
            if not self.game.move(-1, 0):
                director.sound_play("vsjam-may25.vortris/nomueve")
        ...
        if director.was_pressed(director.BUTTON_A):
            director.sound_play("vsjam-may25.vortris/soltar")
