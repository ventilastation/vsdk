...
from .hi_score_manager import *
from .lebal import *
from .hi_score_tag_character import *
from .escena_hi_scores import *

from ..common.label import *
...
class VasuraIngresoHiScore(Scene):
    ...
    def step(self):
        ...
        if director.was_pressed(director.BUTTON_A):
            ...
            if self.current_char_index < 2:
                director.sound_play('vsjam-may25.vasura_espacial/hi_score_char_select')
                self.chars[self.current_char_index].deselect()
                self.current_char_index += 1
                self.chars[self.current_char_index].select()
            else:
                director.sound_play('vsjam-may25.vasura_espacial/hi_score_enter')
                self.chars[self.current_char_index].deselect()
                self.current_char_index += 1
