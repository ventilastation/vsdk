...
from .vasura_scripts.managers.balas_manager import *
from .vasura_scripts.managers.enemigos_manager import *
from .vasura_scripts.managers.gameplay_manager import *

from .vasura_scripts.managers.spawner_enemigos import SpawnerEnemigos

from .vasura_scripts.entities.nave import Nave
from .vasura_scripts.entities.planeta import Planeta

from .vasura_scripts.score.display_puntaje import *
from .vasura_scripts.score.hi_score_manager import *

from .vasura_scripts.escena_game_over import *

class VasuraEspacial(Scene):
    stripes_rom = "vsjam-may25.vasura_espacial"
    def __init__(self):
        super().__init__()
    ...
    def reproducir_bgm(self):
        ...
        director.music_play("vsjam-may25.vasura_espacial/bgm_gameplay")
    ...
    def on_game_over(self):
        ...
        director.sound_play('vsjam-may25.vasura_espacial/explosion_planeta')
