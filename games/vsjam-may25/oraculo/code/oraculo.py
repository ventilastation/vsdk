...
class SpriteAnimationScene(TimedScene):
    ...
    order = []
    imageText = ""
    soundImage = "vsjam-may25.oraculo/audio02"

    def on_enter(self):
        super().on_enter()
        director.music_play(b"vsjam-may25.oraculo/audio02")
...
class Oraculo(Scene):
    def on_enter(self):
        ...
        director.music_play(b"vsjam-may25.oraculo/ruleta")
        self.flecha = Sprite()
    ...
    def step(self):
        if director.was_pressed(director.JOY_DOWN) or director.was_pressed(director.BUTTON_A):
            director.sound_play(b"vsjam-may25.oraculo/click")
            self.detener = True
...
class Inicio(TimedScene):
    duration = 30000
    stripes_rom = "vsjam-may25.oraculo"
    def on_enter(self):
