...
class TinchoLevel(Scene):
    stripes_rom = "vsjam-oct25.tincho_vrunner"
    keep_music = True
    ...
    def on_enter(self):
        ...
        director.music_play("vsjam-oct25.tincho_vrunner/1LFD")
    ...
    def powerup(self):
        ...
        director.sound_play("vsjam-oct25.tincho_vrunner/powerup%d" % randrange(3))
    ...
    def ir_patrás_un_rato(self):
        director.sound_play("vsjam-oct25.tincho_vrunner/rebota%d" % randrange(3))
        self.run_dir = -1
    ...
    def bajar_un_cambio(self):
        ...
        director.sound_play("vsjam-oct25.tincho_vrunner/duele%d" % randrange(3))
