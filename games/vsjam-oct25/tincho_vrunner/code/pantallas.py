...
from .tincho_level import make_me_a_planet, HUD_MODE, INFO_CONTROLES
from .nivel_01 import Nivel01
from .nivel_02 import Nivel02
...
class Título(Scene):
    ...
    def on_enter(self):
        ...
        if not self.ya_mostrado:
            director.sound_play("vsjam-oct25.tincho_vrunner/tincho_carpincho")
