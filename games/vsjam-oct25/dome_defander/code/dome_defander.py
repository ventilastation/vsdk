...
class DomeDefander(Scene):
    stripes_rom = "vsjam-oct25.dome_defander"

    def play_music_loop(self):
        print("Playing")
        # director.music_off()
        director.music_play("vsjam-oct25.dome_defander/play1")
        ...
        if self.state == "playing":
            ...
            if director.was_pressed(director.BUTTON_A):
                ...
                if self.sc.vidas > 0:
                    ...
                    if len(self.cascotes_reserva) > 0:
                        ...
                        director.sound_play(b"vsjam-oct25.dome_defander/cascote1")
            ...
            if self.sc.vidas > 0 and self.state == "playing":
                ...
                if len(self.misiles_activos) > 0 and self.state == "playing":
                    for m in self.misiles_activos:
                        if m.sprite.y() > 48:  # Misil llega al domo
                            ...
                            if self.sc.vidas == 0:
                                # Fin
                                director.sound_play(b"vsjam-oct25.dome_defander/fin")
                                self.nuke.reset()
                                self.end_counter = 0
                                self.dome.hit()
                                self.state = "lose"
                                ...
                                # Hit
                                director.sound_play(b"vsjam-oct25.dome_defander/hit1")
                                m.desactivar()
                ...
                if len(self.misiles_activos) < 3 and self.state == "playing":
                        director.sound_play(b"vsjam-oct25.dome_defander/misil1")
                    ...
                    for c in self.cascotes_activos:
                        if c.delete:
                            ...
                            if len(self.explosiones_reserva) > 0:
                                director.sound_play(b"vsjam-oct25.dome_defander/explosion1")
