...
class FanphibiousDanger(Scene):
    stripes_rom = "vsjam-oct25.fanphibious_danger"
    ...
    def start_music(self):
        director.music_play("vsjam-oct25.fanphibious_danger/music")
    ...
    def step(self):
        ...
        if director.is_pressed(director.JOY_LEFT):
            if self.frog.state == ON_GROUND: #or self.frog.state == ON_GOAL:
                ...
                #director.sound_play("vsjam-oct25.fanphibious_danger/step")
        ...
        if director.was_pressed(director.BUTTON_A):
            if self.frog.state != JUMPING:
                if (self.frog.state != ON_GROUND) or (self.frog.orientation == DIR_FORWARD):
                    ...
                    director.sound_play("vsjam-oct25.fanphibious_danger/jump")
        ...
        if self.frog.state == JUMPING:
            ...
            if self.frog.jumping_frame == MAX_JUMPING_FRAME:
                ...
                if self.frog.ring == 0:
                    ...
                    director.sound_play("vsjam-oct25.fanphibious_danger/goal")
                    ...
                    if dummy_state == ON_WATER:
                        ...
                        director.sound_play("vsjam-oct25.fanphibious_danger/splash")
                    else:
    ...
    def finished(self):
        ...
        director.sound_play("vsjam-oct25.fanphibious_danger/gameover")
