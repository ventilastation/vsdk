...
class GameOver(Scene):
    ...
    def on_enter(self):
        ...
        director.music_play("vsjam-oct25.peronjam/estatizacion")
...
class PeronJam(Scene):
    stripes_rom = "vsjam-oct25.peronjam"
    ...
    def on_enter(self):
        ...
        director.music_play("vsjam-oct25.peronjam/marcha")
    ...
    def step(self):
        ...
        if self.cosito.y() < LIMIT and self.cosito.collision([self.manoi,self.manod]):
            ...
            director.sound_play("vsjam-oct25.peronjam/fx0"+str(randrange(1,6)))
        ...
        if self.cosito.y() < 5:
            self.cosito.set_y(255)
            self.peron.triste()
            director.sound_play("vsjam-oct25.peronjam/traidor")
