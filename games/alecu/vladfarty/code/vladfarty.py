...
class Ready(TimedScene):
    ...
    def on_enter(self):
        ...
        director.music_play(b"alecu.vladfarty/intro")
...
class BuildFuture(Scroller):
    ...
    def on_enter(self):
        super().on_enter()
        director.music_play(b"alecu.vladfarty/happy-place")
...
class DancingLions(TimedScene):
    ...
    def on_enter(self):
        ...
        director.music_play(b"alecu.vladfarty/farty-lion")
        self.increment = 2
    ...
    def start_lionhead(self):
        ...
        director.music_off()
        director.sound_play(b"alecu.vladfarty/hit")
...
class WorldRight(Scroller):
    ...
    def on_enter(self):
        ...
        director.music_play(b"alecu.vladfarty/part2")
...
class Kudowz(TimedScene):
    ...
    def on_enter(self):
        ...
        director.music_play(b"alecu.vladfarty/credits")
