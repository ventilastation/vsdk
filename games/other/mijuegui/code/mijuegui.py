    ...
    def sonidito(self):
       ## director.sound_play(b"vyruss/shoot1")
        if self.contador_sonido < 4:
            ...
            director.sound_play(b"other.mijuegui/3")
            director.sound_play(b"other.mijuegui/4")
            director.sound_play(b"other.mijuegui/5")
            self.contador_sonido +=1
            ...
            director.sound_play(b"other.mijuegui/4")
            director.sound_play(b"other.mijuegui/5")
            director.sound_play(b"other.mijuegui/6")
            self.contador_sonido +=1
