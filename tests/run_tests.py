...
CPYTHON_TESTS = [
    ...
    "tests/test_vs2_scene_gen_model.py",
    "tests/test_vs2_scene_gen_generator.py",
    ...
    "tests/test_vs2_hardware_fixture.py",
    "tests/test_vs2_hardware_test.py",
    "tests/test_vs2_hardware_report.py",
