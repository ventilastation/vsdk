# generated_projectile_fast_fixture.py  -- generated, do not edit. body-sha: 5768e5db
...
class GeneratedProjectile(Behavior):
    ...
    def step(self, sprites):
        ...
        _h_range = self.range
        _h_speed_y = self.speed_y
        live = sprites._live
        index = len(live) - 1
        while index >= 0:
            sprite = live[index]
            sprite.shot_flown += _h_speed_y
            if sprite.shot_flown > _h_range:
                sprite.despawn()
            else:
